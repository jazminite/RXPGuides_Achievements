RXPGuides.RegisterGuide([[
  ...
  step
    >>Talk to the |cRXP_FRIENDLY_Lunar Festival Harbinger|r in The Park.
    .accept 8867
    .goto Stormwind City,23.32,53.13
    .target Lunar Festival Harbinger
  step
    #completewith next
    >>Buy fireworks from the |cRXP_FRIENDLY_Lunar Festival Vendor|r
    .collect 21576,2
    .collect 21557,8
    .goto Stormwind City,22.90,51.16
    .target Lunar Festival Vendor
  step
    >>Use the |cRXP_PICK_Red Rocket Clusters|r and |cRXP_PICK_Small Red Rockets|r in your bag.
    .use 21576
    .use 21557
    .complete 8867,1
    .complete 8867,2
    .goto Stormwind City,23.12,52.13
  step
    ...
    .target Lunar Festival Harbinger
  step
    >>Talk to |cRXP_FRIENDLY_Elder Hammershout|r in The Park
    .accept 8646
    .turnin 8646
    .goto Stormwind City,21.53,53.86
    .target Elder Hammershout
  step
    #completewith next
    .zone Elwynn Forest >> Travel to Elwynn Forest
  step
    >>Talk to |cRXP_FRIENDLY_Elder Stormbrow|r near Goldshire.
    .accept 8649
    .turnin 8649
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Skychaser|r at the top of the Sentinel Hill tower.
    .accept 8675
    .turnin 8675
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Starglade|r outside the ZG entrance.
    .accept 8716
    .turnin 8716
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Winterhoof|r on the Booty Bay docks.
    .accept 8674
    .turnin 8674
    .goto Stranglethorn Vale,27.6,74
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Bellowrage|r in the Crater near Dark Portal.
    .accept 8647
    .turnin 8647
    .goto Blasted Lands,58.8,51.6
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Starsong|r inside the Sunken Temple.
  ...
  step
    ...
    .goto Stormwind City,71.0,72.5
  step
    >>Talk to |cRXP_FRIENDLY_Elder Rumblerock|r near Dreadmaul Rock, Burning Steppes.
    .accept 8636
    .turnin 8636
    .goto Burning Steppes,82.2,46.6
    .target Elder Rumblerock
  step
    >>Talk to |cRXP_FRIENDLY_Elder Dawnstrider|r near Flame Crest, Burning Steppes.
    .accept 8683
    .turnin 8683
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Ironband|r in Blackchar Cave, Searing Gorge.
    .accept 8651
    .turnin 8651
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Stonefort|r inside Lower Blackrock Spire (Hordemar City).
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Morndeep|r at the center of the Ring of Law inside Blackrock Depths.
    .accept 8619
    .turnin 8619
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Bronzebeard|r in the Mystic Ward
    .accept 8866
    .turnin 8866
    .goto Ironforge,29.26,17.09
    .target Elder Bronzebeard
  step
    >>Talk to |cRXP_FRIENDLY_Elder Goldwell|r in Kharanos
    .accept 8653
    .turnin 8653
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Silvervein|r in Thelsamar, Loch Modan.
    .accept 8642
    .turnin 8642
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Highpeak|r in The Hinterlands.
    .accept 8643
    .turnin 8643
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Obsidian|r near The Sepulcher
    .accept 8645
    .turnin 8645
    .goto Silverpine Forest,45.0,41.2
    .target Elder Obsidian
  step
    >>Talk to |cRXP_FRIENDLY_Elder Darkcore|r inside the Undercity entrance courtyard. You don't need to enter Undercity.
    .accept 8648
    .turnin 8648
    .goto Undercity,66.6,38.0
    .target Elder Darkcore
  step
    >>Talk to |cRXP_FRIENDLY_Elder Graveborn|r in Brill.
    .accept 8652
    .turnin 8652
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Moonstrike|r on the Roof of Scholomance.
    .accept 8714
    .turnin 8714
    .goto Eastern Kingdoms,50.88,36.52
    .target Elder Moonstrike
  step
    >>Talk to |cRXP_FRIENDLY_Elder Meadowrun|r near Weeping Cavern in Western Plaguelands.
    .accept 8722
    .turnin 8722
    .goto Western Plaguelands,65.96,47.85
    .target Elder Meadowrun
  step
    >>Talk to |cRXP_FRIENDLY_Elder Windrun|r near Crown Guard Tower in Eastern Plaguelands.
    .accept 8688
    .turnin 8688
    .goto Eastern Plaguelands,35.5,68.8
    .target Elder Windrun
  step
    >>Talk to |cRXP_FRIENDLY_Elder Snowcrown|r at Light's Hope Chapel.
    .accept 8650
    .turnin 8650
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Farwhisper|r inside Stratholme.
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Bladeleaf|r in Dolanaar, Teldrassil.
    .accept 8715
    .turnin 8715
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Bladeswift|r at the Cenarion Enclave in Darnassus.
    .accept 8718
    .turnin 8718
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Starweave|r in Auberdine, Darkshore.
    .accept 8721
    .turnin 8721
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Stonespire|r in Everlook, Winterspring.
    .accept 8672
    .turnin 8672
    .goto Winterspring,61.4,37.8
    .target Elder Stonespire
  step
    >>Talk to |cRXP_FRIENDLY_Elder Brightspear|r near Lake Kel'theril, Winterspring.
    .accept 8726
    .turnin 8726
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Nightwind|r in Jaedenar, Felwood.
    .accept 8723
    .turnin 8723
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Riversong|r in Astranaar, Ashenvale.
    .accept 8725
    .turnin 8725
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Skygleam|r near the Ravencrest Monument in Azshara.
    .accept 8720
    .turnin 8720
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Darkhorn|r in the Valley of Wisdom, Orgrimmar.
    .accept 8677
    .turnin 8677
    .goto Orgrimmar,41.2,33.8
    .target Elder Darkhorn
  step
    >>Talk to |cRXP_FRIENDLY_Elder Runetotem|r in Razor Hill, Durotar.
    .accept 8670
    .turnin 8670
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Windtotem|r in Ratchet.
    .accept 8680
    .turnin 8680
    .goto The Barrens,62.65,36.74
    .target Elder Windtotem
  step
    >>Talk to |cRXP_FRIENDLY_Elder Moonwarden|r in the Crossroads, The Barrens.
    .accept 8717
    .turnin 8717
    .goto The Barrens,51.4,30.6
    .target Elder Moonwarden
  step
    >>Talk to |cRXP_FRIENDLY_Elder High Mountain|r in Camp Taurajo, The Barrens.
    .accept 8686
    .turnin 8686
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Bloodhoof|r near Bloodhoof Village, Mulgore.
    .accept 8673
    .turnin 8673
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Ezra Wheathoof|r at Elder Rise in Thunder Bluff.
    .accept 8678
    .turnin 8678
  ...
  step
    ...
    +Use your |cRXP_PICK_Lunar Festival Invitation|r to port to Moonglade.
    .use 21711
  step
    >>Talk to |cRXP_FRIENDLY_Valadar Starsong|r in Moonglade.
    .turnin 8883
    .accept 8868
  ...
  step
    ...
    .unitscan Omen
  step
    >>WARNING - OMEN IS A LEVEL 70 RAID BOSS - YOU NEED A GROUP TO KILL HIM!
    >>If you don't see Omen's corpse, fire the |cRXP_PICK_20 Rocket Clusters|r into the launcher to summon Omen.
    .use 21574
    .complete 8868,1
    .unitscan Omen
  step
    >>(OPTIONAL) Return to |cRXP_FRIENDLY_Valadar Starsong|r in Moonglade.
    .turnin 8868
    .goto Moonglade,53.6,35.4
    .target Valadar Starsong
  step << Mage
  ...
  step << !Mage
    ...
    +Use the |cRXP_PICK_Lunar Festival Invitation|r to port to Ironforge.
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Dreamseer|r in Gadgetzan, Tanaris.
    .accept 8684
    .turnin 8684
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Wildmane|r inside Zul'Farrak.
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Morningdew|r near the Mirage Raceway in Thousand Needles.
    .accept 8724
    .turnin 8724
    .goto Thousand Needles,79.2,77.0
    .target Elder Morningdew
  step
    >>Talk to |cRXP_FRIENDLY_Elder Skyseer|r at Freewind Post, Thousand Needles (go up the elevator).
    .accept 8682
    .turnin 8682
    .goto Thousand Needles,45.4,50.0
    .target Elder Skyseer
  step
    >>Talk to |cRXP_FRIENDLY_Elder Grimtotem|r at the top of Lariss Pavillion, Feralas.
    .accept 8679
    .turnin 8679
    .goto Feralas,76.72,37.87
    .target Elder Grimtotem
  step
    >>Talk to |cRXP_FRIENDLY_Elder Mistwalker|r in the Dire Maul Arena (outside the instance).
    .accept 8685
    .turnin 8685
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Splitrock|r inside Maraudon.
  ...
  step
    ...
    .goto Dustwallow Marsh,67.47,51.28
  step
    >>Talk to |cRXP_FRIENDLY_Elder Ragetotem|r near the Valley of the Watchers in Tanaris.
    .accept 8671
    .turnin 8671
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Thunderhorn|r near Slithering Scar, Un'Goro Crater.
    .accept 8681
    .turnin 8681
  ...
  step
    >>Talk to |cRXP_FRIENDLY_Elder Bladesing|r in Cenarion Hold, Silithus.
    .accept 8719
    .turnin 8719
    .goto Silithus,49.0,37.6
    .target Elder Bladesing
  step
    >>Talk to |cRXP_FRIENDLY_Elder Primestone|r in Crystal Vale, Silithus.
    .accept 8654
    .turnin 8654
    .goto Silithus,23.0,11.8
    .target Elder Primestone
  step
    >>CONGRATULATIONS!!! You completed this guide!
]])
...
RXPGuides.RegisterGuide([[
  ...
  step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Lunar Festival Harbinger|r in the Orgrimmar Valley of Wisdom
    .accept 8867 >>Accept Lunar Fireworks
    .target Lunar Festival Harbinger
  step
    .goto Orgrimmar,41.36,32.43
    >>Buy fireworks from the |cRXP_FRIENDLY_Lunar Festival Vendor|r 
    .collect 21576,2,8867,1
    .collect 21557,8,8867,1 
    .target Lunar Festival Vendor
  step
    .goto Orgrimmar,41.36,32.43
    >>Use the |cRXP_PICK_Red Rocket Clusters and Small Red Rockets|r in your bag
    .complete 8867,1
    .complete 8867,2 
    .use 21576
    .use 21557
